...
public class FilmController : ControllerBase
{
    ...
    public static List<Film> DataGen ()
    {
        ...
        [
            ...
            new Film("Cube", "Vincenzo Natali", 90, "A group of strangers awaken to find themselves placed in a giant cube. Each one of them is gifted with a special skill and they must work together to escape an endless maze of deadly traps.", (int) FilmAgeRestrictions.overThirteen, "1997", [Enum.GetName(FilmGenres.scienceFiction)], "Cube.jpg"),
            new Film("ET", "Steven Spielberg", 115, "A small alien from another planet is abandoned on Earth when his ship forgets about him. He is all alone and scared until Elliott, a nine-year-old boy, finds him and decides to hide him in his house to protect him.", (int) FilmAgeRestrictions.allPublic, "1982", [Enum.GetName(FilmGenres.scienceFiction)], "ET.jpg"),
            new Film("Hardware", "Richard Stanley", 94, "A cyborg's head reactivates, rebuilds itself and goes on a violent rampage in the apartment of a space marine's girlfriend.", (int) FilmAgeRestrictions.overEighteen, "1990", [Enum.GetName(FilmGenres.scienceFiction), Enum.GetName(FilmGenres.horror)], "Hardware.jpg" ),
            new Film("Matrix", "Lana Wachowski, Lilly Wachowski", 136, "When a beautiful stranger leads hacker Neo into a forbidden underworld, he discovers the shocking truth: the life he knows is an elaborate hoax by an evil cyber-intelligence.", (int) FilmAgeRestrictions.overEighteen, "1999", [Enum.GetName(FilmGenres.scienceFiction)], "Matrix.jpg"),
            new Film("Predator", "John McTiernan", 107, "A group of mercenaries is hired by the CIA to rescue some pilots who have been captured by guerrillas in the Central American jungle.", (int) FilmAgeRestrictions.overEighteen, "1987", [Enum.GetName(FilmGenres.scienceFiction), Enum.GetName(FilmGenres.horror)], "Predator.jpg"),
            new Film("Supernova", "Walter Hill, Francis Ford Coppola, Jack Sholder", 90, "A medical aid spacecraft rescues a mysterious survivor and a strange and menacing alien artifact.", (int) FilmAgeRestrictions.overEighteen, "2000", [Enum.GetName(FilmGenres.scienceFiction), Enum.GetName(FilmGenres.horror)], "Supernova.jpg"),
            new Film("The Fifth Element", "Luc Besson", 126, "In a colorful future, a cab driver unwittingly becomes the central figure in the search for a legendary cosmic weapon to keep Zorg and El Maligno at bay.", (int) FilmAgeRestrictions.overSeven, "1997", [Enum.GetName(FilmGenres.scienceFiction)], "TheFifthElement.jpg")
